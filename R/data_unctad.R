...
##' .. content for \details{} ..
##'
data_unctad <- function(rca_path = "data/US_RCA_ST202009112223_v1.csv",
                        termstrade_path = "data/US_TermsOfTrade_ST202007011402_v1.csv",
                        digitaldata_path = "data/US_TradeServDigital_ST202007241022_v1.csv",
                        tradeopeness_path = "data/US_GoodsAndServTradeOpennessBpm6_ST202009031424_v1.csv",
                        concentration_data = "data/US_ConcentDiversIndices_ST202009111058_v1.csv",
  ...
  # Trade Serv Digital
  digital <- read_csv(digitaldata_path,
    col_types = cols(
      Year = col_double(),
      Economy = col_character(),
      `Economy Label` = col_character(),
    ...
    select(
      -ends_with("foot"), -category, -category_label,
  ...
  concent <- read_csv("data/US_ConcentDiversIndices_ST202009111058_v1.csv",
    ...
    filter(partner == "0000") %>%
    select(
      -ends_with("foot"), -economy, -flow, -partner,
  ...
  data_unctad <- data_un %>%
    ...
    select(year, country_code, all_of(variables_selected)) %>%
    select(-year)
